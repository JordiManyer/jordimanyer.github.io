        ...
        <div class="prose dark:prose-invert max-w-none">
          <section>
            <p class="text-gray-700 dark:text-gray-300">
              My research focuses on developing efficient numerical methods, algorithms and
              software tools for solving numerical PDEs. I work at the intersection 
              of numerical analysis, scientific computing and HPC. 
            </p>
            <p class="text-gray-700 dark:text-gray-300">
              ...
              <ul class="list-disc pl-6">
                ...
                <li>
                  Non-conforming hybrid polytopal methods.
                </li>
              </ul>
            </p>
          </section>
          ...
          <section>
            <h2 class="text-gray-900 dark:text-gray-100">My Projects</h2>
